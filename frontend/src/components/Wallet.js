...
export default function Wallet() {
	return (
		<div className="containerr" style={{ paddingTop: "100px" }}>
						...
						<div className="col-12 mb-4">
							<div className="row box-right">
								...
								<div className="col-md-4">
									{" "}
									<p className="p-blue">
										<span className="fas fa-circle pe-2" />
										Pending{" "}
									</p>
							...
							<div className="box-right">
								...
								<div className="d-flex pb-2">
									...
									<p className="ms-auto p-blue">
										<span className=" bg btn btn-primary fas fa-pencil-alt me-3" />
										<span className=" bg btn btn-primary far fa-clone" />{" "}
									</p>
								</div>{" "}
								<div className="bg-blue p-2">
									{" "}
									<p className="h8 textmuted">
										Lorem ipsum dolor sit amet consectetur
										adipisicing elit. Laborum recusandae
										dolorem voluptas nemo, modi eos minus
										nesciunt.
										<p className="p-blue bg btn btn-primary h8">
											LEARN MORE
										</p>
									</p>
								</div>
							...
							<div className="box-right">
								...
								<div className="d-flex mb-2">
									...
									<p className="ms-auto bg btn btn-primary p-blue h8">
										<span className="far fa-clone pe-2" />
										COPY PAYMENT LINK
									</p>{" "}
								</div>{" "}
								<div className="row">
						...
						<div className="h8">
							...
							<div className="row m-0 border mb-3">
								...
								<div className="col-2 text-center p-0">
									...
									<span className="d-block p-2 border-bottom">
										2
									</span>{" "}
							...
							<div className="h8 mb-5">
								<p className="textmuted">
									Lorem ipsum dolor sit amet elit. Adipisci ea
									harum sed quaerat tenetur{" "}
								</p>
							</div>
						</div>{" "}
						<div className="">
							...
							<p className="textmuted h8 mb-2">
								Make payment for this invoice by filling in the
								details
							</p>
							<div className="form">
								{" "}
								...
								<div className="btn btn-primary d-block h8 mt-2">
									{" "}
									Download Invoice
								</div>
							</div>
